...
public class SystemException extends RuntimeException {
    ...
    private Integer customCode = 200000;

    public SystemException(IBaseEnum basicEnum) {
        this.basicEnum = basicEnum;
        this.customCode = basicEnum.getCode();
        this.customMessage = basicEnum.getMsg();
    }

    public SystemException(String formatString, Object... args) {
        String stringMsg = formatStr(formatString, args);
        this.customMessage = stringMsg;
    }

    public SystemException(Integer customCode, String formatString, Object... args) {
        String stringMsg = formatStr(formatString, args);
        this.customMessage = stringMsg;

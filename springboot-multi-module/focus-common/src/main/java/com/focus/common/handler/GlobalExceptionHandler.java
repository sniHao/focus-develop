package com.focus.common.handler;
...
public class GlobalExceptionHandler {
    ...
    public FocusResult<?> notLoginExceptionHandler(NotLoginException e) {
        return FocusResult.error(e.getMessage(), FocusResultCode.PERMISSION_EXCEPTION.code());
    }
    ...
    public FocusResult<?> responseStatusExceptionHandler(ResponseStatusException e) {
    ...
    public FocusResult<?> businessExceptionHandler(FocusException e) {

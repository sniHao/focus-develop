package com.focus.oauth.core.service;
...
public class BaseDataConsumerService {
    ...
    private BaseDataRemoteService baseDataRemoteService;
    ...
    public UserInfoDTO getUserInfo(Long userId) {
        ...
        try {
            return baseDataRemoteService.getUserInfo(userId);
        } catch (Exception e) {
    ...
    public List<BaseDataDTO> getAllBaseData() {
        ...
        try {
            return baseDataRemoteService.getAllBaseData();
        } catch (Exception e) {
    ...
    public List<BaseDataDTO> getBaseDataByType(String type) {
        ...
        try {
            return baseDataRemoteService.getBaseDataByType(type);
        } catch (Exception e) {
    ...
    public boolean checkUserExists(Long userId) {
        ...
        try {
            return baseDataRemoteService.checkUserExists(userId);
        } catch (Exception e) {
    ...
    public String getSystemConfig(String configKey) {
        ...
        try {
            return baseDataRemoteService.getSystemConfig(configKey);
        } catch (Exception e) {
